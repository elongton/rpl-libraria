<div class="" style="padding: 50px; background-color: #006599;">
...
<div class="container" style="display: flex;">
  ...
  <div class="" style="color: white; padding: 0 15px; display: flex; flex-direction: column;">
    <div class="" style="">
    ...
    <div class="" style="flex-grow: 1; display: flex; align-items: center; justify-content: center;">
      <a href="" style="margin-right: 10px;" class="btn btn-primary">View this Event</a>
